...
//		var_dump($update_param);
    ...
    if (mysql_query($query)) {
        $message = "The project is submitted. You are free to update the project content anytime you like to. Make sure that you subscribe to Disqus board and keep cheking for comments by Ninja's.";
    } else {
        $error = true;
        $message = mysql_error();
    }
