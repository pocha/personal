<?php /* Smarty version 2.6.26, created on 2011-03-20 17:03:12
...
<div class="wrapper1" style="padding:0 100px;">
    ...
    <div id="student_block" style=" border-top: 1px solid black; padding: 0 100px">
			<table style="text-align: left">
				<tr>
					<td><a href="<?php echo $this->_tpl_vars['startup']['FacebookProfileUrl']; ?>
" target="_blank"><img src="<?php echo $this->_tpl_vars['startup']['FacebookPicUrl']; ?>
"  width="100px"/></a></td>
...
" style="text-align:center;">
				<table style="width:100%; font-size: medium">
					<tr>
						<td> <a href="project.php?id=<?php echo $this->_tpl_vars['p']['Id']; ?>
"><?php echo $this->_tpl_vars['p']['Heading']; ?>
</a></td>
					</tr>
					<tr>
						<td>
