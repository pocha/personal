...
<div id="contact" class="section" <?php if ($this->_tpl_vars['tpl_name'] != 'index.tpl'): ?> style="background-color:gray" <?php endif; ?> >
	<div class="contents" style="position:relative;">
		<div id="logo">
			<a href=""><img src="/img/stalk-ninja.png" alt="Stalk Talent"></a>
		</div><!-- /#logo -->
		
		<div class="message" style="<?php if ($this->_tpl_vars['tpl_name'] == 'index.tpl'): ?> color:gray; <?php endif; ?> font-size: 18px; float:left; padding-left: 20px; padding-top: 15px;">
...
<span style="font-size:small" for="mce-EMAIL">Are you interested to know how are we evolving ? Let us reach you :</span>
		...
		<td>
<input type="text" value="Enter Email" name="EMAIL" id="mce-EMAIL" onfocus="<?php echo 'if(this.value == \'Enter Email\') { this.value = \'\'; }'; ?>
" >
<style type="text/css">
<?php echo '
	#mce-EMAIL {
