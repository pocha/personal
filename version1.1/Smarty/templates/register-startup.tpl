...
<table class="form" style="text-align:left; width: 100%">
	...
	<tr><td>Startup Name</td><td><input name="name" value="{$data.name}"/></td></tr>
	<tr><td>Email address</td><td><input name="email" value="{$data.email}"/></td></tr>
        <tr><td>Project Title</td><td><input name="title" value="{$data.title}"/></td></tr>
